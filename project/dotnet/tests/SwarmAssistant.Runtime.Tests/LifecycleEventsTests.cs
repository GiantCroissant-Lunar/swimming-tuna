    ...
    public void TaskCoordinatorActor_OnRoleSucceeded_EmitsRoleSucceededEvent()
    {
        ...
        var coordinator = parentProbe.ChildActorOf(
            Props.Create(() => new TaskCoordinatorActor(
                ...
                ActorRefs.Nobody, roleEngine, goapPlanner, _loggerFactory, _telemetry, uiEvents, registry, _options, null, null, null, 2, 0, null, null, null, null, null)));
    ...
    public void TaskCoordinatorActor_HandleEscalation_EmitsTaskEscalatedEvent()
    {
        ...
        var coordinator = parentProbe.ChildActorOf(
            Props.Create(() => new TaskCoordinatorActor(
                taskId, "Task", "desc",
                workerProbe, reviewerProbe, supervisorProbe, blackboardProbe,
                ActorRefs.Nobody, roleEngine, goapPlanner, _loggerFactory, _telemetry, uiEvents, registry, _options, null, null, null, 0, 0, null, null, null, null, null)));
