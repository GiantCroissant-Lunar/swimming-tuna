    ...
    public void TaskCoordinatorActor_PlannerOutputWithSubTasks_SpawnsSubTasksAndPausesGoap()
    {
        ...
        var coordinator = parentProbe.ChildActorOf(
            Props.Create(() => new TaskCoordinatorActor(
                ...
                ActorRefs.Nobody, roleEngine, goapPlanner, _loggerFactory, _telemetry, _uiEvents, registry, _options, null, null, null, 2, 0, null)));
    ...
    public void TaskCoordinatorActor_SetSubTaskDepthOverride_AppliesPerTask()
    {
        ...
        var coordinator = parentProbe.ChildActorOf(
            Props.Create(() => new TaskCoordinatorActor(
                ...
                workerProbe, reviewerProbe, supervisorProbe, blackboardProbe,
                ActorRefs.Nobody, roleEngine, goapPlanner, _loggerFactory, _telemetry, _uiEvents, registry, options, null, null, null, 2, 0, null)));
