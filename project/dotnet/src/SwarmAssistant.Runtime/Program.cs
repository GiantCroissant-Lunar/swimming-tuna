...
logger.LogInformation(
    "Starting SwarmAssistant.Runtime with profile={Profile}, orchestration={RoleSystem}, agentExecution={AgentExecution}, sandbox={SandboxMode}, langfuse={LangfuseBaseUrl}",
    options.Profile,
    options.RoleSystem,
